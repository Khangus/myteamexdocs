...
To get started on MyTeamEx, the first thing you'll need is to set up a wallet that supports Binance Smart Chain \(BSC\). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with MyTeamEx.
...
* Additional steps needed to use with Binance Smart Chain and MyTeamEx  
...
To connect to Binance Smart Chain and use MyTeamEx, you can follow the TokenPocket section of our Connect Your Wallet to MyTeamEx guide [https://docs.myteamex.finance/get-started/connection-guide](https://docs.myteamex.finance/get-started/connection-guide).
...
The genuine MyTeamEx site and staff will never ask you to input your seed phrase.\*\*
{% endhint %}
...
This comparison table gives an overview of the most popular desktop wallets used with MyTeamEx.
...
* Supports Binance Smart Chain by default, making using MyTeamEx easy  
* Supports a large number of languages  
...
And that’s it, all done! You can follow our [Connect Your Wallet to MyTeamEx guide](https://docs.myteamex.finance/get-started/connection-guide) to connect to Binance Smart Chain and MyTeamEx.
{% endtab %}
{% endtabs %}
