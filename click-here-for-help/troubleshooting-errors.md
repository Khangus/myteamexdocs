...
ometimes you may find yourself facing a problem that doesn't have a clear solution. These troubleshooting tips may help you solve problems you run into.
...
3. Increase your slippage tolerance:
   ...
   2. Increase your slippage tolerance a little and try again. ![](../.gitbook/assets/image-129-.png) 



1. Lastly, try inputting an amount with fewer decimal places.
{% endtab %}
...
3.  ![](../.gitbook/assets/image-129-1-.png) 
{% endtab %}
...
### MyteamexRouter : EXPIRED

> The transaction cannot succeed due to error: MyteamexRouter: EXPIRED. This is probably an issue with one of the tokens you are swapping.
...
You don't have enough SYRUP in your wallet to unstake from the MYC-MYC pool.

{% tabs %}
{% tab title="Solution 1" %}
**Get at least as much SYRUP as the amount of MYC that you’re trying to unstake.**

1. Buy SYRUP on the exchange. If you want to unstake 100 MYC, you need at least 100 SYRUP.
